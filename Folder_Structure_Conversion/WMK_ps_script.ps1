...
########### ROLLBACK ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrDel*" -or $_.Name -like "*ScrRol*" -or $_.Name -like "*ScrDrp*" -or $_.Name -like "*ScrCln*" -or $_.Name -like "*ScrRbk*" -and $_.Directory.Name -match "Custom" -and $_.Directory.Parent.Name -notmatch "Table"}  | New-Item -Type dir "$dstSql\Rollback Scripts\Custom"
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrDel*" -or $_.Name -like "*ScrRol*" -or $_.Name -like "*ScrDrp*" -or $_.Name -like "*ScrCln*" -or $_.Name -like "*ScrRbk*" -and $_.Directory.Name -match "Custom" -and $_.Directory.Parent.Name -notmatch "Table"}  | ForEach-Object { Copy-Item $_.fullname "$dstSql\Rollback Scripts\Custom" -include "*.sq*" }
 
 ############ UPDATE ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrUpd*" -and $_.Directory.Name -match "Custom" -and $_.Directory.parent.Name -notmatch "Table"}  | New-Item -Type dir $dstSql\Update\Custom
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrUpd*" -and $_.Directory.Name -match "Custom" -and $_.Directory.parent.Name -notmatch "Table"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Update\Custom -include "*.sq*" }
...
#*************** STAGE STARTS ********************#
 ...
 ############ ROLLBACK ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrDel*" -or $_.Name -like "*ScrRol*" -or $_.Name -like "*ScrDrp*" -or $_.Name -like "*ScrCln*" -or $_.Name -like "*ScrRbk*" -and $_.Directory.Name -match "Stage" -and $_.Directory.parent.Name -notmatch "Table"}  | New-Item -Type dir "$dstSql\Rollback Scripts\Stage"
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrDel*" -or $_.Name -like "*ScrRol*" -or $_.Name -like "*ScrDrp*" -or $_.Name -like "*ScrCln*" -or $_.Name -like "*ScrRbk*" -and $_.Directory.Name -match "Stage" -and $_.Directory.parent.Name -notmatch "Table"}  | ForEach-Object { Copy-Item $_.fullname "$dstSql\Rollback Scripts\Stage" -include "*.sq*" }
 
 ############ UPDATE ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrUpd*" -and $_.Directory.Name -match "Stage" -and $_.Directory.parent.Name -notmatch "Table"}  | New-Item -Type dir $dstSql\Update\Stage
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrUpd*" -and $_.Directory.Name -match "Stage" -and $_.Directory.parent.Name -notmatch "Table"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Update\Stage -include "*.sq*" }
...
############ ROLLBACK ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrDel*" -or $_.Name -like "*ScrRol*" -or $_.Name -like "*ScrDrp*" -or $_.Name -like "*ScrCln*" -or $_.Name -like "*ScrRbk*" -and $_.DirectoryName -match "Facet" -and $_.Directory.Name -notmatch "Custom" -and $_.Directory.Name -notmatch "Stage" -and $_.Directory.Name -notmatch "FacetsXC"}  | New-Item -Type dir "$dstSql\Rollback Scripts\Facets"
 ...
 ############ UPDATE ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrUpd*" -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir $dstSql\Update\Facets
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrUpd*" -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Update\Facets -include "*.sq*" }
 
 ############ OTS ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrOts*" -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir $dstSql\OTS\Facets
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrOts*" -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\OTS\Facets -include "*.sq*" }
 
 ############ FUNCTIONS ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Extension -eq ".sqp"  -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -match "Function"  -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir "$dstSql\Functions\Facets"
 ...
 ############ ALTER SCRIPTS ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrAlt*" -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir "$dstSql\Alter Scripts\Facets"
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrAlt*" -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname "$dstSql\Alter Scripts\Facets" -include "*.sq*" }
 
 ############ INSERT SCRIPTS ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrIns*" -and $_.DirectoryName -match "Facet"  -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir "$dstSql\Insert Scripts\Facets"
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrIns*" -and $_.DirectoryName -match "Facet"  -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname "$dstSql\Insert Scripts\Facets" -include "*.sq*" }
 
 ############ SQT TABLE SCRIPTS ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Extension -eq ".sqt" -and $_.DirectoryName -match "Table" -and $_.DirectoryName -match "Facet" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir "$dstSql\Table Scripts\Facets"
 ...
 ############VIEWS##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "View"  -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir $dstSql\Views\Facets
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "View" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Views\Facets -include "*.sq*" }
 #Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "View"}  | New-Item -Type dir $dstSql\Views
 #Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "View"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Views -include "*.sql" }
 
 ############ INDEXES ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "Index" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir $dstSql\Indexes\Facets
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "Index" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Indexes\Facets -include "*.sq*" }
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.Name -like "*ScrInx*" -and $_.Directory.Name -match "Facet" -and $_.Directory.parent.Name -notmatch "Table" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir $dstSql\Indexes\Stage
 ...
 ############ TRIGGERS ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "Trigger" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir $dstSql\Triggers\Facets
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "Trigger" -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Triggers\Facets -include "*.sq*" }
 #Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Trigger"}  | New-Item -Type dir $dstSql\Triggers
 #Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Trigger"}  | ForEach-Object { Copy-Item $_.fullname $dstSql\Triggers -include "*.sql" }
 
 ############ STORED PROCEDURES ##########
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "Stored Procedure"  -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | New-Item -Type dir "$dstSql\Stored Procedures\Facets"
 Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Facet" -and $_.Directory.Parent.Name -match "Stored Procedure"  -and $_.DirectoryName -notmatch "Custom" -and $_.DirectoryName -notmatch "Stage" -and $_.DirectoryName -notmatch "FacetsXC"}  | ForEach-Object { Copy-Item $_.fullname "$dstSql\Stored Procedures\Facets" -include "*.sq*" }
 #Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Stored Procedure"}  | New-Item -Type dir "$dstSql\Stored Procedures"
 #Get-ChildItem $source\$content\$_  -Recurse | Where-Object { $_.DirectoryName -match "Stored Procedure"}  | ForEach-Object { Copy-Item $_.fullname "$dstSql\Stored Procedures" -include "*.sql" }
...
Remove-Item "$source\$content\$final_name\Files_Logs.txt"
